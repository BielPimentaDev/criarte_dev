...
export default function Checked({ id, core_status, cover_status }) {
  ...
  return (
    <>
      ...
      <label className={checkedCore ? 'line-through' : ''}>Miolo <input type="checkbox" onClick={checkCore} checked={checkedCore} ></input></label>
      <label className={checkedCover ? 'line-through' : ''}>Capa <input type="checkbox" onClick={checkCover} checked={checkedCover} ></input></label>
